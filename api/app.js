...
const restaurants =[
    ...
    { id: 1, nom:"La Taverne du Chevalier" , etablissement: "Restaurant", ville: " Castelbourg", avis: 4, image:"https://i.ibb.co/QfLtLNC/taverne-1.jpg" , presentation:" Une retraite chaleureuse où les chevaliers fatigués peuvent savourer des mets copieux dans une ambiance rustique, entourés d'armures étincelantes et de bannières colorées."  },
     { id: 2, nom:"L'Auberge du Dragon d'Or" , etablissement: "Taverne", ville: " Castelbourg", avis: 4, image:"https://i.ibb.co/QfLtLNC/taverne-1.jpg" , presentation:"Un lieu mystique où les convives peuvent déguster des plats exotiques sous le regard bienveillant d'une statue de dragon doré, créant une atmosphère magique et intrigante."  },
     { id: 3, nom:"Le Festin du Château" , etablissement: "Taverne", ville: "Tourmaline", avis: 4, image:"https://i.ibb.co/QfLtLNC/taverne-1.jpg" , presentation:" Un établissement majestueux situé au pied d'un château, proposant une cuisine raffinée et des festins somptueux pour la noblesse locale et les voyageurs distingués."  },
     { id: 3, nom:"La Broche Royale" , etablissement: "Restaurant", ville: " Castelbourg", avis: 4, image:"https://i.ibb.co/QfLtLNC/taverne-1.jpg" , presentation:"Célèbre pour ses viandes rôties à la broche, cette taverne propose des mets succulents servis dans une ambiance animée, avec des musiciens jouant des mélodies entraînantes."  },
     { id: 5, nom:"La Table du Royaume" , etablissement: "Taverne", ville: " Castelbourg", avis: 4, image:"https://i.ibb.co/QfLtLNC/taverne-1.jpg" , presentation:"Un restaurant accueillant qui offre une expérience gastronomique pour tous les goûts, mettant en avant des plats régionaux et des spécialités du royaume."  },
     { id: 6, nom:"La Potence Gourmande" , etablissement: "Restaurant", ville: "Clairbois", avis: 4, image:"https://i.ibb.co/QfLtLNC/taverne-1.jpg" , presentation:" Un lieu singulier où les plats sont suspendus à des potences au-dessus des tables, créant une atmosphère unique et intrigante pour les convives aventureux."  },
 ...
 const activites = [
    ...
    { id: 11, nameA: 'Jeu d Echec', textA: 'Bienvenue, nobles esprits tactiques, sur l échiquier du Jeu d Échecs, où rois et reines dirigent leurs armées dans une danse stratégique. Chaque coup est une manœuvre audacieuse, et la victoire appartient à celui qui peut anticiper les mouvements de son adversaire avec astuce. Que votre esprit soit aiguisé comme une lame de chevalier, et que vos pièces avancent avec la grâce des nobles sur le champ de bataille.', imgA: 'https://i.ibb.co/2yVCCWX/11.png', localisationA: 'Castelbourg', rateA: '3.5', moneyEA: '2', moneyAA: '5', moneyFA: '10', clockSA: '10h - 12h', clockWA: 'h - h'},
    { id: 12, nameA: 'Jeu de cartes', textA: 'Que la chance vous sourie au Jeu de Cartes, où les rois, dames et valets s alignent dans des combinaisons mystérieuses. Les cartes sont le reflet du destin, et chaque partie est une aventure où la ruse et la chance s entremêlent. Puissiez-vous jouer vos atouts avec sagesse et triompher dans cette joute de hasard et d habileté.', imgA: 'https://i.ibb.co/g3CsfVG/12.png', localisationA: 'Clairbois', rateA: '4.5', moneyEA: '2', moneyAA: '5', moneyFA: '10', clockSA: 'h - h', clockWA: '10h - 13h'},
    { id: 13, nameA: 'Jeu de l oie', textA: 'Bienvenue sur le plateau du Jeu de l Oie, où chaque lancer de dé vous rapproche du triomphe ou du défi. Les cases dévoilent des mystères et des embûches, et seuls les joueurs les plus rusés réussiront à atteindre la case finale. Que votre chemin soit semé de bonnes fortunes, et que la victoire vous mène avec légèreté sur le chemin enchanté de cette course ludique.', imgA: 'https://i.ibb.co/s62cwDn/Erreur.png', localisationA: 'Tourmaline', rateA: '4', moneyEA: '10', moneyAA: '15', moneyFA: '35', clockSA: 'h - h', clockWA: '14h - 18h'},
    { id: 14, nameA: 'Course orientation', textA: 'Partez à l aventure dans la forêt dense de la Course d Orientation, où la boussole est votre guide et la carte votre compagne. Les balises dissimulées dans l épaisse végétation exigent une connaissance astucieuse du terrain et une compréhension fine de l orientation. Que vos pas soient assurés et que votre sens de l aventure vous mène à travers bois et vallées vers la victoire finale.', imgA: 'https://i.ibb.co/dBCgQvC/14.png', localisationA: 'Havresombre', rateA: '2.7', moneyEA: '5', moneyAA: '10', moneyFA: '20', clockSA: 'h - h', clockWA: '14h - 18h'},
    { id: 15, nameA: 'A venir', textA: '-', imgA: 'https://i.ibb.co/s62cwDn/Erreur.png', localisationA: 'Forgefroid', rateA: '-', moneyEA: '-', moneyAA: '-', moneyFA: '-', clockSA: 'h - h', clockWA: 'h - h'},
    { id: 16, nameA: 'Tir à l arc', textA: 'Bienvenue, braves compétiteurs, à l Arène du Tir à l Arc, où les flèches volent telle une pluie de lances dans un ballet gracieux. Les archers, habiles et précis, défient les cibles lointaines avec une détermination digne des héros des légendes anciennes. Que votre œil soit affûté et votre arc tendu, car la gloire vous attend au bout de chaque volée.', imgA: 'https://i.ibb.co/RB56F3d/16.png', localisationA: 'Célestopolis', rateA: '4.7', moneyEA: '10', moneyAA: '15', moneyFA: '30', clockSA: '10h - 16h', clockWA: '8h - 18h'},
    { id: 17, nameA: 'Lancé de Javelot', textA: 'Que les Dieux guident vos lances au Champ de Lancé de Javelot, où les guerriers athlétiques mesurent leur force et leur adresse. L air vibrant du passage des javelots ajoute une musique virile à cette compétition, où seuls les plus vaillants sauront faire trembler les cieux de leur habileté et de leur bravoure.', imgA: 'https://i.ibb.co/PMyHxVN/17.jpg', localisationA: 'Brisevent', rateA: '3.8', moneyEA: '5', moneyAA: '8', moneyFA: '15', clockSA: 'h - h', clockWA: '10h - 12h'},
    { id: 18, nameA: 'Equitation', textA: 'Sellez vos destriers et entrez dans l arène équestre, où l art noble de l Équitation prend vie. Cavaliers et chevaux ne font qu un, exécutant des mouvements gracieux et puissants dans une danse harmonieuse. Que le galop de votre monture résonne tel le tonnerre, emportant votre renommée au galop vers les sommets.', imgA: 'https://i.ibb.co/5L7CVDN/18.png', localisationA: 'Sylvestrie', rateA: '3.1', moneyEA: '15', moneyAA: '25', moneyFA: '60', clockSA: '16h - 18h', clockWA: '10h - 16h'},
    { id: 19, nameA: 'Course de Cheval', textA: 'Sur la piste de Course, que vos jambes soient rapides comme le vent, défiant la distance avec une détermination féroce. Les foules acclament les athlètes qui franchissent la ligne d arrivée, glorifiant leur agilité et leur endurance dans cette épreuve où chaque pas compte.', imgA: 'https://i.ibb.co/7vCy0hy/19.jpg', localisationA: 'Aubeclaire', rateA: '1.5', moneyEA: '0', moneyAA: '0', moneyFA: '0', clockSA: 'h - h', clockWA: '13h - 15h'},
    { id: 20, nameA: 'Jeu de Paume', textA: 'Bienvenue au Jeu de Paume, où la balle rebondit sur les murs comme le destin lui-même. Les joueurs rivalisent dans un ballet frénétique, utilisant des raquettes habilement maniées pour renvoyer la balle avec une précision digne des plus grands stratèges. Que chaque échange soit une démonstration de virtuosité, captivant les spectateurs dans cette joute athlétique digne des cours royales.', imgA: 'https://i.ibb.co/s62cwDn/Erreur.png', localisationA: 'Montéclat', rateA: '4.6', moneyEA: '3', moneyAA: '8', moneyFA: '20', clockSA: '16h - 18h', clockWA: '14h - 18h'},
